...
#
#SAVE_DIR="results_iclr/results_hofstede_test_format_"$ENGINE"_perm_"$PERMUTATIONS"_format"
#mkdir -p $SAVE_DIR
#
...
SAVE_DIR="results_iclr/results_hofstede_test_sim_conv_"$ENGINE"_perm_"$PERMUTATIONS"_theme"
mkdir -p $SAVE_DIR
# conversation
python -u evaluate.py \
--permutations 50 \
...
#for theme in "${themes[@]}"; do
#
#SAVE_DIR="results_iclr/results_hofstede_test_sim_conv_explicit_values_"$vals"_"$ENGINE"_perm_"$PERMUTATIONS"_theme"
#mkdir -p $SAVE_DIR
## conversation
#python -u evaluate.py \
#--permutations 50 \
...
SAVE_DIR="results_iclr/results_AI_wiki_context_v2_no_separator_music_expert_hofstede_test_"$ENGINE"_perm_"$PERMUTATIONS"_"$message"_msg_"$person"_prs"
