...
#
#         super(DeepSeekModel, self).__init__(model_id, *args, **kwargs)
#
...
#
#         print(colored("Using DeepSeek API", "red"))
#         time.sleep(1)
#
#         self.load_args = {
#             "api_key": os.getenv("DS_API_KEY"), "base_url": "https://api.deepseek.com"
#         }
