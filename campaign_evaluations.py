...
if figure_name == "no_pop_msgs":
    ...
    # title = "Rank-Order Personal value stability of fictional characters"
    # title = "Simulated fictional characters (PVQ)"
    title = "(A)"
    ...
    # title = "Simulated real-world personas (the Religion task)"
    title = "(C)"
    ...
    # title = f"Simulated fictional characters (donation amount - {value_to_pair})"
    title = letter
    ...
    # title = "Simulated real-world personas (PVQ)"
    title = "(B)"
    ...
    # title = "Simulated fictional characters (the Donation task)"
    title = "(A)"
    ...
    # title = "Simulated fictional characters (the Stealing task)"
...
elif figure_name.startswith("tolk_ro_msgs"):
    ...
    raise ValueError(f"Undefined fig_type: {args.fig_name}")
...
fig_path = f'visualizations/PLOSONE/{figure_name}.png'
print(f"save to: {fig_path}")
plt.savefig(fig_path)
