...
# bad_guys = [
#     "Gollum", "Sauron", "Saruman", "Smaug", "Morgoth", "Shelob", "Gríma Wormtongue",
...
#     "Faramir", "Éowyn", "Samwise Gamgee", "Fëanor", "Théoden", "Boromir", "Túrin Turambar",
#     "Thranduil", "Beorn", "Arwen", "Halbarad", "Fingon", "Fingolfin", "Celebrimbor", "Gil-galad",
#     "Meriadoc Brandybuck", "Treebeard", "Radagast", "Elendil", "Éomer", "Legolas", "Húrin",
#     "Thorin Oakenshield", "Peregrin Took", "Thingol", "Eärendil", "Elwing", "Lúthien", "Beren",
#     "Tuor", "Idril", "Finwë", "Míriel", "Bard the Bowman", "Melian", "Balin", "Gimli",
# ]
#
# neutral_guys = [
#     "Smeagol",
